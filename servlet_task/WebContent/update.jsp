          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Student Update form</h3>
                
                 <div class="form-outline mb-4">
                  <input type="text" id="form3Example8"  name="id" class="form-control form-control-lg" />
                ...
                <div class="row" >
                  <div class="col-md-6 mb-4">
                    ...
                    <select class="select" name="city">
                      ...
                      <option value="Dubai">America</option>
